...
extension Persistence {
    ...
    /// Production state stays private to the app process. The widget receives
    /// its bounded now-playing projection through shared UserDefaults and does
    /// not open these databases.
    static var applicationStateFileURL: URL {
