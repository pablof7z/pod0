...
// MARK: - PodcastAgentToolValues+Inventory
//
// Inventory, category, clip, and TTS result envelopes for the podcast tool
// surface. Split out of `PodcastAgentToolValues.swift` purely for file-size
// hygiene — see that file's header for the general rationale.
