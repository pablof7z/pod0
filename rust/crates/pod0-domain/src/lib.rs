...
opaque_id!(ActivityId, uniffi::Record);
opaque_id!(ActivityTransactionId, uniffi::Record);
opaque_id!(ActivityCorrelationId, uniffi::Record);
opaque_id!(EffectIntentId, uniffi::Record);
opaque_id!(EffectAttemptId, uniffi::Record);
opaque_id!(EffectLeaseId, uniffi::Record);
opaque_id!(InternalCommandId, uniffi::Record);
...
opaque_id!(PublicationId, uniffi::Record);
opaque_id!(PublicationRouteId, uniffi::Record);
