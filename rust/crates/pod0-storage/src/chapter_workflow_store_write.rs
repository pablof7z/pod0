...
impl LibraryStore {
    pub fn commit_publisher_chapter_observation(
        &self,
        input: crate::PublisherChapterObservationCommitInput,
    ) -> Result<crate::PublisherChapterObservationCommitOutcome, StorageError> {
        crate::transition_commit::commit_publisher_chapter_observation(self.path(), input)
    }
    ...
    #[allow(clippy::too_many_arguments)]
    pub(crate) fn apply_publisher_chapter_ensure(
        ...
        let expected_selection_revision = selected.map_or(StateRevision::INITIAL, |item| item.1);
        ...
        transaction
            ...
            .map_err(|error| StorageError::sqlite("ensure publisher chapter workflow", error))?;
        let record =
    ...
    pub fn fail_publisher_chapter_workflow(
        ...
        self.write(|transaction| Self::apply_publisher_chapter_failure(transaction, input))
    }

    pub(crate) fn apply_publisher_chapter_failure(
        transaction: &rusqlite::Transaction<'_>,
        input: PublisherChapterWorkflowFailureInput,
    ) -> Result<PublisherChapterWorkflowUpdate, StorageError> {
    ...
    pub fn cancel_publisher_chapter_workflow(
        ...
        self.write(|transaction| {
            Self::apply_publisher_chapter_cancellation(
                transaction,
                episode_id,
                expected_revision,
                now_ms,
    ...
    pub(crate) fn apply_publisher_chapter_cancellation(
        transaction: &rusqlite::Transaction<'_>,
        episode_id: EpisodeId,
        expected_revision: StateRevision,
        now_ms: i64,
