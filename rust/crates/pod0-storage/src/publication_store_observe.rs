...
impl PublicationStore {
    pub fn observe_leased(
        ...
        crate::transition_commit::commit_publication_observation(&self.path, input, observed_at)
    }
}
...
pub(crate) fn observe_in_transaction(
    ...
    let encoded = serde_json::to_vec(observation).map_err(|_| StorageError::InvalidPublication)?;
