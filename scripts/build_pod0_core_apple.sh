...
mkdir -p \
  ...
  "$TEMP_ROOT/ios-arm64_x86_64-simulator/Headers"
cp "$CARGO_OUTPUT/aarch64-apple-ios/release/libpod0_facade.a" \
  "$TEMP_ROOT/ios-arm64/libpod0_facade.a"
lipo -create \
  "$CARGO_OUTPUT/aarch64-apple-ios-sim/release/libpod0_facade.a" \
  "$CARGO_OUTPUT/x86_64-apple-ios/release/libpod0_facade.a" \
  -output "$TEMP_ROOT/ios-arm64_x86_64-simulator/libpod0_facade.a"
