...
The about field in profile editing is not projected back by AccountSummary, so it must be cached locally on the client (SharedPreferences on Android, UserDefaults on iOS) matching iOS behavior, not faked as a kernel read-back. <!-- [^c1691-404] -->
