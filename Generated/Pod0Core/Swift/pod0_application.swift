...
public struct AgentModelUsageObservation: Equatable, Hashable {
    public let promptTokens: UInt64
    public let completionTokens: UInt64
    public let cachedPromptTokens: UInt64?

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(promptTokens: UInt64, completionTokens: UInt64, cachedPromptTokens: UInt64?) {
...
#if compiler(>=6)
extension AgentModelUsageObservation: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeAgentModelUsageObservation: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AgentModelUsageObservation {
        return
            try AgentModelUsageObservation(
                promptTokens: FfiConverterUInt64.read(from: &buf),
                completionTokens: FfiConverterUInt64.read(from: &buf),
                cachedPromptTokens: FfiConverterOptionUInt64.read(from: &buf)
        )
    }

    public static func write(_ value: AgentModelUsageObservation, into buf: inout [UInt8]) {
        FfiConverterUInt64.write(value.promptTokens, into: &buf)
        FfiConverterUInt64.write(value.completionTokens, into: &buf)
        FfiConverterOptionUInt64.write(value.cachedPromptTokens, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAgentModelUsageObservation_lift(_ buf: RustBuffer) throws -> AgentModelUsageObservation {
    return try FfiConverterTypeAgentModelUsageObservation.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAgentModelUsageObservation_lower(_ value: AgentModelUsageObservation) -> RustBuffer {
    return FfiConverterTypeAgentModelUsageObservation.lower(value)
}


public struct AgentModelUsageProjection: Equatable, Hashable {
    public let modelReference: String
    public let promptTokens: UInt64
    public let completionTokens: UInt64
    public let cachedPromptTokens: UInt64?
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(modelReference: String, promptTokens: UInt64, completionTokens: UInt64, cachedPromptTokens: UInt64?, observedAt: UnixTimestampMilliseconds) {
        self.modelReference = modelReference
        self.promptTokens = promptTokens
        self.completionTokens = completionTokens
        self.cachedPromptTokens = cachedPromptTokens
...
#if compiler(>=6)
extension AgentModelUsageProjection: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeAgentModelUsageProjection: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AgentModelUsageProjection {
        return
            try AgentModelUsageProjection(
                modelReference: FfiConverterString.read(from: &buf),
                promptTokens: FfiConverterUInt64.read(from: &buf),
                completionTokens: FfiConverterUInt64.read(from: &buf),
                cachedPromptTokens: FfiConverterOptionUInt64.read(from: &buf),
    ...
    public static func write(_ value: AgentModelUsageProjection, into buf: inout [UInt8]) {
        FfiConverterString.write(value.modelReference, into: &buf)
        FfiConverterUInt64.write(value.promptTokens, into: &buf)
        FfiConverterUInt64.write(value.completionTokens, into: &buf)
        FfiConverterOptionUInt64.write(value.cachedPromptTokens, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAgentModelUsageProjection_lift(_ buf: RustBuffer) throws -> AgentModelUsageProjection {
    return try FfiConverterTypeAgentModelUsageProjection.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAgentModelUsageProjection_lower(_ value: AgentModelUsageProjection) -> RustBuffer {
    return FfiConverterTypeAgentModelUsageProjection.lower(value)
}
...
public struct AgentTurnProjection: Equatable, Hashable {
    ...
    public let modelUsage: [AgentModelUsageProjection]
    public let proposal: AgentProposalProjection?
    public let executionFenceId: AgentExecutionFenceId?
...
public struct FfiConverterTypeAgentTurnProjection: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AgentTurnProjection {
        return
            try AgentTurnProjection(
                ...
                modelUsage: FfiConverterSequenceTypeAgentModelUsageProjection.read(from: &buf),
    ...
    public static func write(_ value: AgentTurnProjection, into buf: inout [UInt8]) {
        ...
        FfiConverterSequenceTypeAgentModelUsageProjection.write(value.modelUsage, into: &buf)
...
public struct MemoriesProjection: Equatable, Hashable {
    public let scope: MemoryProjectionScope
    public let collectionRevision: StateRevision
    public let memories: [MemoryRecord]
    public let compiled: CompiledMemoryRecord?
    public let operations: [OperationProjection]
    public let hasMore: Bool

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(scope: MemoryProjectionScope, collectionRevision: StateRevision, memories: [MemoryRecord], compiled: CompiledMemoryRecord?, operations: [OperationProjection], hasMore: Bool) {
        self.scope = scope
        self.collectionRevision = collectionRevision
...
#if compiler(>=6)
extension MemoriesProjection: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMemoriesProjection: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MemoriesProjection {
        return
            try MemoriesProjection(
                scope: FfiConverterTypeMemoryProjectionScope.read(from: &buf),
                collectionRevision: FfiConverterTypeStateRevision.read(from: &buf),
                memories: FfiConverterSequenceTypeMemoryRecord.read(from: &buf),
                compiled: FfiConverterOptionTypeCompiledMemoryRecord.read(from: &buf),
                operations: FfiConverterSequenceTypeOperationProjection.read(from: &buf),
                hasMore: FfiConverterBool.read(from: &buf)
        )
    }

    public static func write(_ value: MemoriesProjection, into buf: inout [UInt8]) {
        FfiConverterTypeMemoryProjectionScope.write(value.scope, into: &buf)
        FfiConverterTypeStateRevision.write(value.collectionRevision, into: &buf)
        FfiConverterSequenceTypeMemoryRecord.write(value.memories, into: &buf)
        FfiConverterOptionTypeCompiledMemoryRecord.write(value.compiled, into: &buf)
        FfiConverterSequenceTypeOperationProjection.write(value.operations, into: &buf)
        FfiConverterBool.write(value.hasMore, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMemoriesProjection_lift(_ buf: RustBuffer) throws -> MemoriesProjection {
    return try FfiConverterTypeMemoriesProjection.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMemoriesProjection_lower(_ value: MemoriesProjection) -> RustBuffer {
    return FfiConverterTypeMemoriesProjection.lower(value)
}
...
public struct PublicationsProjection: Equatable, Hashable {
    public let items: [PublicationRecord]
    public let operations: [OperationProjection]
    public let hasMore: Bool

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(items: [PublicationRecord], operations: [OperationProjection], hasMore: Bool) {
        self.items = items
        self.operations = operations
        self.hasMore = hasMore
    }
...
#if compiler(>=6)
extension PublicationsProjection: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypePublicationsProjection: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PublicationsProjection {
        return
            try PublicationsProjection(
                items: FfiConverterSequenceTypePublicationRecord.read(from: &buf),
                operations: FfiConverterSequenceTypeOperationProjection.read(from: &buf),
                hasMore: FfiConverterBool.read(from: &buf)
        )
    }

    public static func write(_ value: PublicationsProjection, into buf: inout [UInt8]) {
        FfiConverterSequenceTypePublicationRecord.write(value.items, into: &buf)
        FfiConverterSequenceTypeOperationProjection.write(value.operations, into: &buf)
        FfiConverterBool.write(value.hasMore, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypePublicationsProjection_lift(_ buf: RustBuffer) throws -> PublicationsProjection {
    return try FfiConverterTypePublicationsProjection.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypePublicationsProjection_lower(_ value: PublicationsProjection) -> RustBuffer {
    return FfiConverterTypePublicationsProjection.lower(value)
}
...
public struct FfiConverterTypeAgentToolAction: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AgentToolAction {
        ...
        case 5: return .episode(tool: try FfiConverterTypeAgentToolName.read(from: &buf), episodeId: try FfiConverterTypeEpisodeId.read(from: &buf)
        )

        case 6: return .podcast(tool: try FfiConverterTypeAgentToolName.read(from: &buf), podcastId: try FfiConverterTypePodcastId.read(from: &buf)
        )

        case 7: return .playEpisode(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), startMilliseconds: try FfiConverterOptionUInt64.read(from: &buf), endMilliseconds: try FfiConverterOptionUInt64.read(from: &buf), placement: try FfiConverterTypeQueuePlacement.read(from: &buf)
        )

        case 8: return .setPlaybackRate(permille: try FfiConverterUInt16.read(from: &buf)
        )

        case 9: return .setSleepTimer(durationMilliseconds: try FfiConverterOptionUInt64.read(from: &buf)
        )

        case 10: return .createNote(text: try FfiConverterString.read(from: &buf)
        )

        case 11: return .recordMemory(text: try FfiConverterString.read(from: &buf)
        )

        case 12: return .ask(question: try FfiConverterString.read(from: &buf), context: try FfiConverterOptionString.read(from: &buf)
        )

        case 13: return .scheduleTask(task: try FfiConverterTypeScheduledTaskInput.read(from: &buf)
        )

        case 14: return .cancelScheduledTask(taskId: try FfiConverterTypeScheduledTaskId.read(from: &buf), expectedRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )
...
public enum ApplicationCommand: Equatable, Hashable {
    ...
    case setSubscriptionTranscriptStartPolicy(podcastId: PodcastId, policy: TranscriptStartPolicy
    )
    ...
    case createMemory(content: String
    )
    case updateMemory(memoryId: MemoryId, expectedMemoryRevision: MemoryRevision, content: String
    )
    case setMemoryDeleted(memoryId: MemoryId, expectedMemoryRevision: MemoryRevision, deleted: Bool
    )
    case clearMemories(expectedCollectionRevision: StateRevision
    )
...
public struct FfiConverterTypeApplicationCommand: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ApplicationCommand {
        ...
        case 10: return .setSubscriptionTranscriptStartPolicy(podcastId: try FfiConverterTypePodcastId.read(from: &buf), policy: try FfiConverterTypeTranscriptStartPolicy.read(from: &buf)
        )

        case 11: return .setEpisodeStarred(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), starred: try FfiConverterBool.read(from: &buf)
        )

        case 12: return .requestEpisodeDownload(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), origin: try FfiConverterTypeDownloadIntentOrigin.read(from: &buf)
        )

        case 13: return .reportAutomaticDownloadCandidates(podcastId: try FfiConverterTypePodcastId.read(from: &buf), episodeIds: try FfiConverterSequenceTypeEpisodeId.read(from: &buf)
        )

        case 14: return .cancelEpisodeDownload(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), expectedWorkflowRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 15: return .removeEpisodeDownload(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), expectedWorkflowRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 16: return .observeDownloadEnvironment(observation: try FfiConverterTypeDownloadEnvironmentObservation.read(from: &buf)
        )

        case 17: return .resetListeningData

        case 18: return .requestPlayback(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf)
        )

        case 19: return .playback(command: try FfiConverterTypePlaybackCommand.read(from: &buf)
        )

        case 20: return .recallQuery(query: try FfiConverterTypeRecallQuery.read(from: &buf)
        )

        case 21: return .importLegacyRecallConfiguration(configuration: try FfiConverterTypeRecallConfigurationInput.read(from: &buf), sourceGeneration: try FfiConverterTypeContentDigest.read(from: &buf)
        )

        case 22: return .setRecallConfiguration(expectedConfigurationRevision: try FfiConverterTypeStateRevision.read(from: &buf), configuration: try FfiConverterTypeRecallConfigurationInput.read(from: &buf)
        )

        case 23: return .rebuildTranscriptEvidence(input: try FfiConverterTypeTranscriptEvidenceInput.read(from: &buf), policy: try FfiConverterTypeEvidenceChunkPolicy.read(from: &buf)
        )

        case 24: return .commitRecallIndexCutover

        case 25: return .commitTranscript(expectedSelectionRevision: try FfiConverterTypeStateRevision.read(from: &buf), artifact: try FfiConverterTypeTranscriptArtifactInput.read(from: &buf)
        )

        case 26: return .ensureTranscriptWorkflow(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), origin: try FfiConverterTypeTranscriptWorkflowOrigin.read(from: &buf), configuration: try FfiConverterTypeTranscriptWorkflowConfiguration.read(from: &buf)
        )

        case 27: return .retryTranscriptWorkflow(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), expectedWorkflowRevision: try FfiConverterTypeStateRevision.read(from: &buf), configuration: try FfiConverterTypeTranscriptWorkflowConfiguration.read(from: &buf)
        )

        case 28: return .cancelTranscriptWorkflow(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), expectedWorkflowRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 29: return .ensureScheduledTask(task: try FfiConverterTypeScheduledTaskInput.read(from: &buf)
        )

        case 30: return .updateScheduledTask(taskId: try FfiConverterTypeScheduledTaskId.read(from: &buf), expectedTaskRevision: try FfiConverterTypeStateRevision.read(from: &buf), task: try FfiConverterTypeScheduledTaskInput.read(from: &buf)
        )

        case 31: return .removeScheduledTask(taskId: try FfiConverterTypeScheduledTaskId.read(from: &buf), expectedTaskRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 32: return .reconcileScheduledRuns

        case 33: return .retryScheduledRun(occurrenceId: try FfiConverterTypeScheduledOccurrenceId.read(from: &buf), expectedWorkflowRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 34: return .cancelScheduledRun(occurrenceId: try FfiConverterTypeScheduledOccurrenceId.read(from: &buf), expectedWorkflowRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 35: return .startAgentTurn(conversationId: try FfiConverterOptionTypeConversationId.read(from: &buf), userInput: try FfiConverterString.read(from: &buf), modelReference: try FfiConverterString.read(from: &buf)
        )

        case 36: return .publishGeneratedEpisode(intent: try FfiConverterTypePublicationIntent.read(from: &buf)
        )

        case 37: return .ensureNostrSigner

        case 38: return .signOutNostrSigner(expectedAccountId: try FfiConverterTypeSignerAccountId.read(from: &buf)
        )

        case 39: return .cancelAgentTurn(turnId: try FfiConverterTypeAgentTurnId.read(from: &buf), expectedTurnRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 40: return .commitChapter(expectedSelectionRevision: try FfiConverterTypeStateRevision.read(from: &buf), artifact: try FfiConverterTypeChapterArtifactInput.read(from: &buf)
        )

        case 41: return .ensurePublisherChapters(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf)
        )

        case 42: return .retryPublisherChapters(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), expectedWorkflowRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 43: return .cancelPublisherChapters(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), expectedWorkflowRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 44: return .ensureModelChapters(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), configuredModel: try FfiConverterString.read(from: &buf)
        )

        case 45: return .retryModelChapters(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), configuredModel: try FfiConverterString.read(from: &buf), expectedWorkflowRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 46: return .cancelModelChapters(episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), expectedWorkflowRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 47: return .createNote(text: try FfiConverterString.read(from: &buf), kind: try FfiConverterTypeNoteKind.read(from: &buf), author: try FfiConverterTypeNoteAuthor.read(from: &buf), target: try FfiConverterOptionTypeNoteTarget.read(from: &buf)
        )

        case 48: return .updateNote(noteId: try FfiConverterTypeNoteId.read(from: &buf), expectedNoteRevision: try FfiConverterTypeNoteRevision.read(from: &buf), text: try FfiConverterString.read(from: &buf), kind: try FfiConverterTypeNoteKind.read(from: &buf), target: try FfiConverterOptionTypeNoteTarget.read(from: &buf)
        )

        case 49: return .setNoteDeleted(noteId: try FfiConverterTypeNoteId.read(from: &buf), expectedNoteRevision: try FfiConverterTypeNoteRevision.read(from: &buf), deleted: try FfiConverterBool.read(from: &buf)
        )

        case 50: return .clearNotes(expectedCollectionRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 51: return .createMemory(content: try FfiConverterString.read(from: &buf)
        )

        case 52: return .updateMemory(memoryId: try FfiConverterTypeMemoryId.read(from: &buf), expectedMemoryRevision: try FfiConverterTypeMemoryRevision.read(from: &buf), content: try FfiConverterString.read(from: &buf)
        )

        case 53: return .setMemoryDeleted(memoryId: try FfiConverterTypeMemoryId.read(from: &buf), expectedMemoryRevision: try FfiConverterTypeMemoryRevision.read(from: &buf), deleted: try FfiConverterBool.read(from: &buf)
        )

        case 54: return .clearMemories(expectedCollectionRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 55: return .createClip(clipId: try FfiConverterTypeClipId.read(from: &buf), episodeId: try FfiConverterTypeEpisodeId.read(from: &buf), podcastId: try FfiConverterTypePodcastId.read(from: &buf), startMilliseconds: try FfiConverterUInt64.read(from: &buf), endMilliseconds: try FfiConverterUInt64.read(from: &buf), caption: try FfiConverterOptionString.read(from: &buf), speakerId: try FfiConverterOptionTypeSpeakerId.read(from: &buf), frozenTranscriptText: try FfiConverterString.read(from: &buf), source: try FfiConverterTypeClipSource.read(from: &buf)
        )

        case 56: return .updateClip(clipId: try FfiConverterTypeClipId.read(from: &buf), expectedClipRevision: try FfiConverterTypeClipRevision.read(from: &buf), startMilliseconds: try FfiConverterUInt64.read(from: &buf), endMilliseconds: try FfiConverterUInt64.read(from: &buf), caption: try FfiConverterOptionString.read(from: &buf), speakerId: try FfiConverterOptionTypeSpeakerId.read(from: &buf), frozenTranscriptText: try FfiConverterString.read(from: &buf)
        )

        case 57: return .setClipDeleted(clipId: try FfiConverterTypeClipId.read(from: &buf), expectedClipRevision: try FfiConverterTypeClipRevision.read(from: &buf), deleted: try FfiConverterBool.read(from: &buf)
        )

        case 58: return .clearClips(expectedCollectionRevision: try FfiConverterTypeStateRevision.read(from: &buf)
        )

        case 59: return .cancelOperation(cancellationId: try FfiConverterTypeCancellationId.read(from: &buf)
        )

        case 60: return .unsupported(wireCode: try FfiConverterUInt32.read(from: &buf)
        )
...
public struct FfiConverterTypeCoreFailureCode: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CoreFailureCode {
        ...
        case 8: return .invalidMemory

        case 9: return .invalidNote

        case 10: return .invalidClip

        case 11: return .invalidTranscript

        case 12: return .invalidChapter

        case 13: return .hostUnavailable

        case 14: return .unauthorized

        case 15: return .hostRejected
...
public struct FfiConverterTypeHostObservation: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> HostObservation {
        ...
        case 20: return .nostrSignerCredentialReady(accountId: try FfiConverterTypeSignerAccountId.read(from: &buf), publicKeyHex: try FfiConverterString.read(from: &buf)
        )

        case 21: return .nostrEventSigned(value: try FfiConverterTypeNostrSignatureObservation.read(from: &buf)
        )

        case 22: return .nostrSignerCredentialDeleted(accountId: try FfiConverterTypeSignerAccountId.read(from: &buf)
        )
...
public struct FfiConverterTypeHostRequest: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> HostRequest {
        ...
        case 25: return .provisionNostrSignerCredential

        case 26: return .restoreNostrSignerCredential(accountId: try FfiConverterTypeSignerAccountId.read(from: &buf), expectedAuthorHex: try FfiConverterString.read(from: &buf)
        )

        case 27: return .signNostrEvent(request: try FfiConverterTypeNostrSigningRequest.read(from: &buf)
        )

        case 28: return .deleteNostrSignerCredential(accountId: try FfiConverterTypeSignerAccountId.read(from: &buf)
        )

        case 29: return .scheduleCoreWake(wakeAt: try FfiConverterTypeUnixTimestampMilliseconds.read(from: &buf), reason: try FfiConverterTypeCoreWakeReason.read(from: &buf)
        )

        case 30: return .removeLegacyRecallIndexArtifacts
...
public enum MemoryProjectionScope: Equatable, Hashable {
...
#if compiler(>=6)
extension MemoryProjectionScope: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMemoryProjectionScope: FfiConverterRustBuffer {
    typealias SwiftType = MemoryProjectionScope

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MemoryProjectionScope {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: MemoryProjectionScope, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMemoryProjectionScope_lift(_ buf: RustBuffer) throws -> MemoryProjectionScope {
    return try FfiConverterTypeMemoryProjectionScope.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMemoryProjectionScope_lower(_ value: MemoryProjectionScope) -> RustBuffer {
    return FfiConverterTypeMemoryProjectionScope.lower(value)
}
...
public enum OperationResult: Equatable, Hashable {
    ...
    case notesCleared
    case memoryCreated(memoryId: MemoryId, memoryRevision: MemoryRevision, collectionRevision: StateRevision
    )
    case memoryUpdated(memoryId: MemoryId, memoryRevision: MemoryRevision, collectionRevision: StateRevision
    )
    case memoriesCleared(collectionRevision: StateRevision
    )
...
public enum PlaybackCommand: Equatable, Hashable {
    ...
    case restore
    case play(transcriptConfiguration: TranscriptWorkflowConfiguration?
    )
    case pause
...
public struct FfiConverterTypePlaybackCommand: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PlaybackCommand {
        ...
        case 3: return .play(transcriptConfiguration: try FfiConverterOptionTypeTranscriptWorkflowConfiguration.read(from: &buf)
        )
    ...
    public static func write(_ value: PlaybackCommand, into buf: inout [UInt8]) {
        ...
        case let .play(transcriptConfiguration):
            writeInt(&buf, Int32(3))
            FfiConverterOptionTypeTranscriptWorkflowConfiguration.write(transcriptConfiguration, into: &buf)
...
public struct FfiConverterTypeProjection: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Projection {
        ...
        case 16: return .publications(value: try FfiConverterTypePublicationsProjection.read(from: &buf)
        )

        case 17: return .nostrSigner(value: try FfiConverterTypeSignerProjection.read(from: &buf)
        )
...
public struct FfiConverterTypeProjectionScope: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ProjectionScope {
        ...
        case 16: return .publications(publicationId: try FfiConverterOptionTypePublicationId.read(from: &buf)
        )

        case 17: return .nostrSigner
    ...
    public static func write(_ value: ProjectionScope, into buf: inout [UInt8]) {
        ...
        case let .publications(publicationId):
            writeInt(&buf, Int32(16))
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeAgentModelUsageObservation: FfiConverterRustBuffer {
    typealias SwiftType = AgentModelUsageObservation?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeAgentModelUsageObservation.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeAgentModelUsageObservation.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeTranscriptWorkflowConfiguration: FfiConverterRustBuffer {
    typealias SwiftType = TranscriptWorkflowConfiguration?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeTranscriptWorkflowConfiguration.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeTranscriptWorkflowConfiguration.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeCompiledMemoryRecord: FfiConverterRustBuffer {
    typealias SwiftType = CompiledMemoryRecord?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeCompiledMemoryRecord.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeCompiledMemoryRecord.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypePublicationId: FfiConverterRustBuffer {
    typealias SwiftType = PublicationId?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypePublicationId.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypePublicationId.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeAgentModelUsageProjection: FfiConverterRustBuffer {
    typealias SwiftType = [AgentModelUsageProjection]

    public static func write(_ value: [AgentModelUsageProjection], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeAgentModelUsageProjection.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [AgentModelUsageProjection] {
        let len: Int32 = try readInt(&buf)
        var seq = [AgentModelUsageProjection]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeAgentModelUsageProjection.read(from: &buf))
        }
        return seq
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypePublicationRecord: FfiConverterRustBuffer {
    typealias SwiftType = [PublicationRecord]

    public static func write(_ value: [PublicationRecord], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypePublicationRecord.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [PublicationRecord] {
        let len: Int32 = try readInt(&buf)
        var seq = [PublicationRecord]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypePublicationRecord.read(from: &buf))
        }
        return seq
    }
}
