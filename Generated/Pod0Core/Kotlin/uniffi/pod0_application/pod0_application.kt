...
import uniffi.pod0_domain.CompiledMemoryRecord
...
import uniffi.pod0_domain.FfiConverterTypeCompiledMemoryRecord
...
import uniffi.pod0_domain.FfiConverterTypeTranscriptStartPolicy
...
import uniffi.pod0_domain.TranscriptStartPolicy
...
import uniffi.pod0_domain.RustBuffer as RustBufferCompiledMemoryRecord
...
import uniffi.pod0_domain.RustBuffer as RustBufferTranscriptStartPolicy
...
data class MemoriesProjection (
    val `scope`: MemoryProjectionScope
    ,
    val `collectionRevision`: StateRevision
    ,
    val `memories`: List<MemoryRecord>
    ,
    val `compiled`: CompiledMemoryRecord?
    ,
    val `operations`: List<OperationProjection>
    ,
    val `hasMore`: kotlin.Boolean
 ...
 * @suppress
 */
public object FfiConverterTypeMemoriesProjection: FfiConverterRustBuffer<MemoriesProjection> {
    override fun read(buf: ByteBuffer): MemoriesProjection {
        return MemoriesProjection(
            FfiConverterTypeMemoryProjectionScope.read(buf),
            FfiConverterTypeStateRevision.read(buf),
            FfiConverterSequenceTypeMemoryRecord.read(buf),
            FfiConverterOptionalTypeCompiledMemoryRecord.read(buf),
            FfiConverterSequenceTypeOperationProjection.read(buf),
            FfiConverterBoolean.read(buf),
        )
    }

    override fun allocationSize(value: MemoriesProjection) = (
            FfiConverterTypeMemoryProjectionScope.allocationSize(value.`scope`) +
            FfiConverterTypeStateRevision.allocationSize(value.`collectionRevision`) +
            FfiConverterSequenceTypeMemoryRecord.allocationSize(value.`memories`) +
            FfiConverterOptionalTypeCompiledMemoryRecord.allocationSize(value.`compiled`) +
            FfiConverterSequenceTypeOperationProjection.allocationSize(value.`operations`) +
            FfiConverterBoolean.allocationSize(value.`hasMore`)
    )

    override fun write(value: MemoriesProjection, buf: ByteBuffer) {
            FfiConverterTypeMemoryProjectionScope.write(value.`scope`, buf)
            FfiConverterTypeStateRevision.write(value.`collectionRevision`, buf)
            FfiConverterSequenceTypeMemoryRecord.write(value.`memories`, buf)
            FfiConverterOptionalTypeCompiledMemoryRecord.write(value.`compiled`, buf)
            FfiConverterSequenceTypeOperationProjection.write(value.`operations`, buf)
            FfiConverterBoolean.write(value.`hasMore`, buf)
    }
}
 ...
 * native application.
 */
data class TranscriptWorkflowConfiguration (
 ...
 * @suppress
 */
public object FfiConverterTypeTranscriptWorkflowConfiguration: FfiConverterRustBuffer<TranscriptWorkflowConfiguration> {
    override fun read(buf: ByteBuffer): TranscriptWorkflowConfiguration {
    ...
    override fun allocationSize(value: TranscriptWorkflowConfiguration) = (
    ...
    override fun write(value: TranscriptWorkflowConfiguration, buf: ByteBuffer) {
...
sealed class ApplicationCommand {
    ...
    data class SetSubscriptionTranscriptStartPolicy(
        val `podcastId`: uniffi.pod0_domain.PodcastId,
        val `policy`: uniffi.pod0_domain.TranscriptStartPolicy) : ApplicationCommand()
    ...
    data class ReportAutomaticDownloadCandidates(
        val `podcastId`: uniffi.pod0_domain.PodcastId,
        val `episodeIds`: List<uniffi.pod0_domain.EpisodeId>) : ApplicationCommand()
    ...
    data class EnsureTranscriptWorkflow(
        val `episodeId`: uniffi.pod0_domain.EpisodeId,
        val `origin`: uniffi.pod0_application.TranscriptWorkflowOrigin,
        val `configuration`: uniffi.pod0_application.TranscriptWorkflowConfiguration) : ApplicationCommand()
    ...
    data class RetryTranscriptWorkflow(
        val `episodeId`: uniffi.pod0_domain.EpisodeId,
        val `expectedWorkflowRevision`: uniffi.pod0_domain.StateRevision,
        val `configuration`: uniffi.pod0_application.TranscriptWorkflowConfiguration) : ApplicationCommand()
    ...
    data class CancelTranscriptWorkflow(
        val `episodeId`: uniffi.pod0_domain.EpisodeId,
        val `expectedWorkflowRevision`: uniffi.pod0_domain.StateRevision) : ApplicationCommand()
    ...
    data class CreateMemory(
        val `content`: kotlin.String) : ApplicationCommand()
    ...
    data class UpdateMemory(
        val `memoryId`: uniffi.pod0_domain.MemoryId,
        val `expectedMemoryRevision`: uniffi.pod0_domain.MemoryRevision,
        val `content`: kotlin.String) : ApplicationCommand()
...
public object FfiConverterTypeApplicationCommand : FfiConverterRustBuffer<ApplicationCommand>{
    override fun read(buf: ByteBuffer): ApplicationCommand {
        return when(buf.getInt()) {
            ...
            10 -> ApplicationCommand.SetSubscriptionTranscriptStartPolicy(
                FfiConverterTypePodcastId.read(buf),
                FfiConverterTypeTranscriptStartPolicy.read(buf),
                )
            11 -> ApplicationCommand.SetEpisodeStarred(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterBoolean.read(buf),
                )
            12 -> ApplicationCommand.RequestEpisodeDownload(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeDownloadIntentOrigin.read(buf),
                )
            13 -> ApplicationCommand.ReportAutomaticDownloadCandidates(
                FfiConverterTypePodcastId.read(buf),
                FfiConverterSequenceTypeEpisodeId.read(buf),
                )
            14 -> ApplicationCommand.CancelEpisodeDownload(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            15 -> ApplicationCommand.RemoveEpisodeDownload(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            16 -> ApplicationCommand.ObserveDownloadEnvironment(
                FfiConverterTypeDownloadEnvironmentObservation.read(buf),
                )
            17 -> ApplicationCommand.ResetListeningData
            18 -> ApplicationCommand.RequestPlayback(
                FfiConverterTypeEpisodeId.read(buf),
                )
            19 -> ApplicationCommand.Playback(
                FfiConverterTypePlaybackCommand.read(buf),
                )
            20 -> ApplicationCommand.RecallQuery(
                FfiConverterTypeRecallQuery.read(buf),
                )
            21 -> ApplicationCommand.ImportLegacyRecallConfiguration(
                FfiConverterTypeRecallConfigurationInput.read(buf),
                FfiConverterTypeContentDigest.read(buf),
                )
            22 -> ApplicationCommand.SetRecallConfiguration(
                FfiConverterTypeStateRevision.read(buf),
                FfiConverterTypeRecallConfigurationInput.read(buf),
                )
            23 -> ApplicationCommand.RebuildTranscriptEvidence(
                FfiConverterTypeTranscriptEvidenceInput.read(buf),
                FfiConverterTypeEvidenceChunkPolicy.read(buf),
                )
            24 -> ApplicationCommand.CommitRecallIndexCutover
            25 -> ApplicationCommand.CommitTranscript(
                FfiConverterTypeStateRevision.read(buf),
                FfiConverterTypeTranscriptArtifactInput.read(buf),
                )
            26 -> ApplicationCommand.EnsureTranscriptWorkflow(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeTranscriptWorkflowOrigin.read(buf),
                FfiConverterTypeTranscriptWorkflowConfiguration.read(buf),
                )
            27 -> ApplicationCommand.RetryTranscriptWorkflow(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                FfiConverterTypeTranscriptWorkflowConfiguration.read(buf),
                )
            28 -> ApplicationCommand.CancelTranscriptWorkflow(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            29 -> ApplicationCommand.EnsureScheduledTask(
                FfiConverterTypeScheduledTaskInput.read(buf),
                )
            30 -> ApplicationCommand.UpdateScheduledTask(
                FfiConverterTypeScheduledTaskId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                FfiConverterTypeScheduledTaskInput.read(buf),
                )
            31 -> ApplicationCommand.RemoveScheduledTask(
                FfiConverterTypeScheduledTaskId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            32 -> ApplicationCommand.ReconcileScheduledRuns
            33 -> ApplicationCommand.RetryScheduledRun(
                FfiConverterTypeScheduledOccurrenceId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            34 -> ApplicationCommand.CancelScheduledRun(
                FfiConverterTypeScheduledOccurrenceId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            35 -> ApplicationCommand.StartAgentTurn(
                FfiConverterOptionalTypeConversationId.read(buf),
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                )
            36 -> ApplicationCommand.PublishGeneratedEpisode(
                FfiConverterTypePublicationIntent.read(buf),
                )
            37 -> ApplicationCommand.EnsureNostrSigner
            38 -> ApplicationCommand.SignOutNostrSigner(
                FfiConverterTypeSignerAccountId.read(buf),
                )
            39 -> ApplicationCommand.CancelAgentTurn(
                FfiConverterTypeAgentTurnId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            40 -> ApplicationCommand.CommitChapter(
                FfiConverterTypeStateRevision.read(buf),
                FfiConverterTypeChapterArtifactInput.read(buf),
                )
            41 -> ApplicationCommand.EnsurePublisherChapters(
                FfiConverterTypeEpisodeId.read(buf),
                )
            42 -> ApplicationCommand.RetryPublisherChapters(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            43 -> ApplicationCommand.CancelPublisherChapters(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            44 -> ApplicationCommand.EnsureModelChapters(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterString.read(buf),
                )
            45 -> ApplicationCommand.RetryModelChapters(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterString.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            46 -> ApplicationCommand.CancelModelChapters(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeStateRevision.read(buf),
                )
            47 -> ApplicationCommand.CreateNote(
                FfiConverterString.read(buf),
                FfiConverterTypeNoteKind.read(buf),
                FfiConverterTypeNoteAuthor.read(buf),
                FfiConverterOptionalTypeNoteTarget.read(buf),
                )
            48 -> ApplicationCommand.UpdateNote(
            ...
            49 -> ApplicationCommand.SetNoteDeleted(
                FfiConverterTypeNoteId.read(buf),
                FfiConverterTypeNoteRevision.read(buf),
                FfiConverterBoolean.read(buf),
                )
            50 -> ApplicationCommand.ClearNotes(
                FfiConverterTypeStateRevision.read(buf),
                )
            51 -> ApplicationCommand.CreateMemory(
                FfiConverterString.read(buf),
                )
            52 -> ApplicationCommand.UpdateMemory(
                FfiConverterTypeMemoryId.read(buf),
                FfiConverterTypeMemoryRevision.read(buf),
                FfiConverterString.read(buf),
                )
            53 -> ApplicationCommand.SetMemoryDeleted(
                FfiConverterTypeMemoryId.read(buf),
                FfiConverterTypeMemoryRevision.read(buf),
                FfiConverterBoolean.read(buf),
                )
            54 -> ApplicationCommand.ClearMemories(
                FfiConverterTypeStateRevision.read(buf),
                )
            55 -> ApplicationCommand.CreateClip(
            ...
            56 -> ApplicationCommand.UpdateClip(
                FfiConverterTypeClipId.read(buf),
            ...
            57 -> ApplicationCommand.SetClipDeleted(
                FfiConverterTypeClipId.read(buf),
                FfiConverterTypeClipRevision.read(buf),
                FfiConverterBoolean.read(buf),
                )
            58 -> ApplicationCommand.ClearClips(
                FfiConverterTypeStateRevision.read(buf),
                )
            59 -> ApplicationCommand.CancelOperation(
                FfiConverterTypeCancellationId.read(buf),
                )
            60 -> ApplicationCommand.Unsupported(
                FfiConverterUInt.read(buf),
                )
            else -> throw RuntimeException("invalid enum value, something is very wrong!!")
        }
    ...
    override fun allocationSize(value: ApplicationCommand): ULong = when(value) {
        ...
        is ApplicationCommand.SetSubscriptionTranscriptStartPolicy -> {
            ...
            (
                4UL
                + FfiConverterTypePodcastId.allocationSize(value.`podcastId`)
                + FfiConverterTypeTranscriptStartPolicy.allocationSize(value.`policy`)
            )
        }
        ...
        is ApplicationCommand.UpdateMemory -> {
            ...
            (
                ...
                + FfiConverterTypeMemoryRevision.allocationSize(value.`expectedMemoryRevision`)
                + FfiConverterString.allocationSize(value.`content`)
            )
        }
...
sealed class CoreFailureCode {
    ...
    object InvalidMemory : CoreFailureCode()
...
public object FfiConverterTypeCoreFailureCode : FfiConverterRustBuffer<CoreFailureCode>{
    override fun read(buf: ByteBuffer): CoreFailureCode {
        return when(buf.getInt()) {
            ...
            8 -> CoreFailureCode.InvalidMemory
            9 -> CoreFailureCode.InvalidNote
            10 -> CoreFailureCode.InvalidClip
            11 -> CoreFailureCode.InvalidTranscript
            12 -> CoreFailureCode.InvalidChapter
            13 -> CoreFailureCode.HostUnavailable
            14 -> CoreFailureCode.Unauthorized
            15 -> CoreFailureCode.HostRejected
            16 -> CoreFailureCode.Cancelled
            17 -> CoreFailureCode.Unsupported(
                FfiConverterUInt.read(buf),
                )
            else -> throw RuntimeException("invalid enum value, something is very wrong!!")
        }
    ...
    override fun allocationSize(value: CoreFailureCode): ULong = when(value) {
        ...
        is CoreFailureCode.InvalidMemory -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
            )
...
sealed class CoreWakeReason {
    ...
    data class TranscriptProviderRecovery(
        val `episodeId`: uniffi.pod0_domain.EpisodeId,
        val `attemptId`: uniffi.pod0_domain.TranscriptAttemptId,
        val `submissionFenceId`: uniffi.pod0_domain.TranscriptSubmissionFenceId) : CoreWakeReason()
    ...
    data class TranscriptFinalization(
        val `requestId`: uniffi.pod0_domain.HostRequestId) : CoreWakeReason()
...
public object FfiConverterTypeCoreWakeReason : FfiConverterRustBuffer<CoreWakeReason>{
    override fun read(buf: ByteBuffer): CoreWakeReason {
        return when(buf.getInt()) {
            ...
            3 -> CoreWakeReason.TranscriptProviderRecovery(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeTranscriptAttemptId.read(buf),
                FfiConverterTypeTranscriptSubmissionFenceId.read(buf),
                )
            4 -> CoreWakeReason.TranscriptRetry(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeTranscriptAttemptId.read(buf),
                FfiConverterTypeTranscriptSubmissionFenceId.read(buf),
                )
            5 -> CoreWakeReason.TranscriptFinalization(
                FfiConverterTypeHostRequestId.read(buf),
                )
            6 -> CoreWakeReason.Unsupported(
                FfiConverterUInt.read(buf),
                )
            else -> throw RuntimeException("invalid enum value, something is very wrong!!")
        }
    ...
    override fun allocationSize(value: CoreWakeReason): ULong = when(value) {
        ...
        is CoreWakeReason.TranscriptProviderRecovery -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
                + FfiConverterTypeEpisodeId.allocationSize(value.`episodeId`)
        ...
        is CoreWakeReason.TranscriptRetry -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
                + FfiConverterTypeEpisodeId.allocationSize(value.`episodeId`)
        ...
        is CoreWakeReason.TranscriptFinalization -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
                + FfiConverterTypeHostRequestId.allocationSize(value.`requestId`)
...
public object FfiConverterTypeHostObservation : FfiConverterRustBuffer<HostObservation>{
    override fun read(buf: ByteBuffer): HostObservation {
        return when(buf.getInt()) {
            ...
            20 -> HostObservation.NostrSignerCredentialReady(
                FfiConverterTypeSignerAccountId.read(buf),
                FfiConverterString.read(buf),
                )
            21 -> HostObservation.NostrEventSigned(
                FfiConverterTypeNostrSignatureObservation.read(buf),
                )
            22 -> HostObservation.NostrSignerCredentialDeleted(
                FfiConverterTypeSignerAccountId.read(buf),
                )
...
public object FfiConverterTypeHostRequest : FfiConverterRustBuffer<HostRequest>{
    override fun read(buf: ByteBuffer): HostRequest {
        return when(buf.getInt()) {
            ...
            25 -> HostRequest.ProvisionNostrSignerCredential
            26 -> HostRequest.RestoreNostrSignerCredential(
                FfiConverterTypeSignerAccountId.read(buf),
                FfiConverterString.read(buf),
                )
            27 -> HostRequest.SignNostrEvent(
                FfiConverterTypeNostrSigningRequest.read(buf),
                )
            28 -> HostRequest.DeleteNostrSignerCredential(
                FfiConverterTypeSignerAccountId.read(buf),
                )
            29 -> HostRequest.ScheduleCoreWake(
                FfiConverterTypeUnixTimestampMilliseconds.read(buf),
                FfiConverterTypeCoreWakeReason.read(buf),
                )
            30 -> HostRequest.RemoveLegacyRecallIndexArtifacts
            31 -> HostRequest.Unsupported(
                FfiConverterUInt.read(buf),
                )
            else -> throw RuntimeException("invalid enum value, something is very wrong!!")
        }
...
sealed class MemoryProjectionScope {

    object All : MemoryProjectionScope()


    object Active : MemoryProjectionScope()


    data class Unsupported(
        val `wireCode`: kotlin.UInt) : MemoryProjectionScope()
 ...
 * @suppress
 */
public object FfiConverterTypeMemoryProjectionScope : FfiConverterRustBuffer<MemoryProjectionScope>{
    override fun read(buf: ByteBuffer): MemoryProjectionScope {
        return when(buf.getInt()) {
            1 -> MemoryProjectionScope.All
            2 -> MemoryProjectionScope.Active
            3 -> MemoryProjectionScope.Unsupported(
                FfiConverterUInt.read(buf),
                )
            else -> throw RuntimeException("invalid enum value, something is very wrong!!")
        }
    ...
    override fun allocationSize(value: MemoryProjectionScope): ULong = when(value) {
        is MemoryProjectionScope.All -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
            )
        }
        is MemoryProjectionScope.Active -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
            )
        }
        is MemoryProjectionScope.Unsupported -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
                + FfiConverterUInt.allocationSize(value.`wireCode`)
    ...
    override fun write(value: MemoryProjectionScope, buf: ByteBuffer) {
        when(value) {
            is MemoryProjectionScope.All -> {
                buf.putInt(1)
                Unit
...
sealed class OperationResult {
    ...
    data class MemoryCreated(
        val `memoryId`: uniffi.pod0_domain.MemoryId,
        val `memoryRevision`: uniffi.pod0_domain.MemoryRevision,
    ...
    override fun allocationSize(value: OperationResult): ULong = when(value) {
        ...
        is OperationResult.MemoryCreated -> {
            ...
            (
                4UL
                + FfiConverterTypeMemoryId.allocationSize(value.`memoryId`)
                + FfiConverterTypeMemoryRevision.allocationSize(value.`memoryRevision`)
                + FfiConverterTypeStateRevision.allocationSize(value.`collectionRevision`)
            )
        }
...
sealed class PlaybackCommand {
    ...
    data class Play(
        val `transcriptConfiguration`: uniffi.pod0_application.TranscriptWorkflowConfiguration?) : PlaybackCommand()
...
public object FfiConverterTypePlaybackCommand : FfiConverterRustBuffer<PlaybackCommand>{
    override fun read(buf: ByteBuffer): PlaybackCommand {
        return when(buf.getInt()) {
            ...
            3 -> PlaybackCommand.Play(
                FfiConverterOptionalTypeTranscriptWorkflowConfiguration.read(buf),
                )
    ...
    override fun allocationSize(value: PlaybackCommand): ULong = when(value) {
        ...
        is PlaybackCommand.Play -> {
            ...
            (
                4UL
                + FfiConverterOptionalTypeTranscriptWorkflowConfiguration.allocationSize(value.`transcriptConfiguration`)
            )
        }
    ...
    override fun write(value: PlaybackCommand, buf: ByteBuffer) {
        when(value) {
            ...
            is PlaybackCommand.Play -> {
                buf.putInt(3)
                FfiConverterOptionalTypeTranscriptWorkflowConfiguration.write(value.`transcriptConfiguration`, buf)
                Unit
            }
            is PlaybackCommand.Pause -> {
                buf.putInt(4)
...
sealed class Projection {
    ...
    data class TranscriptWorkflows(
        val `value`: uniffi.pod0_application.TranscriptWorkflowsProjection) : Projection()
    ...
    data class Memories(
        val `value`: uniffi.pod0_application.MemoriesProjection) : Projection()
...
public object FfiConverterTypeProjection : FfiConverterRustBuffer<Projection>{
    override fun read(buf: ByteBuffer): Projection {
        return when(buf.getInt()) {
            ...
            9 -> Projection.TranscriptWorkflows(
                FfiConverterTypeTranscriptWorkflowsProjection.read(buf),
                )
            10 -> Projection.Chapter(
                FfiConverterTypeChapterArtifactProjection.read(buf),
                )
            11 -> Projection.ChapterWorkflows(
    ...
    override fun allocationSize(value: Projection): ULong = when(value) {
        ...
        is Projection.TranscriptWorkflows -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
                + FfiConverterTypeTranscriptWorkflowsProjection.allocationSize(value.`value`)
            )
        }
        ...
        is Projection.Memories -> {
            ...
            (
                4UL
                + FfiConverterTypeMemoriesProjection.allocationSize(value.`value`)
            )
        }
        is Projection.Clips -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
    ...
    override fun write(value: Projection, buf: ByteBuffer) {
        when(value) {
            ...
            is Projection.TranscriptWorkflows -> {
                buf.putInt(9)
                FfiConverterTypeTranscriptWorkflowsProjection.write(value.`value`, buf)
                Unit
            }
            is Projection.Chapter -> {
                buf.putInt(10)
...
sealed class ProjectionScope {
    ...
    data class Memories(
        val `scope`: uniffi.pod0_application.MemoryProjectionScope) : ProjectionScope()
...
public object FfiConverterTypeProjectionScope : FfiConverterRustBuffer<ProjectionScope>{
    override fun read(buf: ByteBuffer): ProjectionScope {
        return when(buf.getInt()) {
            ...
            9 -> ProjectionScope.TranscriptWorkflows(
                FfiConverterOptionalTypeEpisodeId.read(buf),
                )
            10 -> ProjectionScope.Chapter(
                FfiConverterTypeEpisodeId.read(buf),
                FfiConverterTypeChapterProjectionScope.read(buf),
                )
            11 -> ProjectionScope.ChapterWorkflows(
                FfiConverterOptionalTypeEpisodeId.read(buf),
                )
            ...
            17 -> ProjectionScope.NostrSigner
    ...
    override fun allocationSize(value: ProjectionScope): ULong = when(value) {
        ...
        is ProjectionScope.TranscriptWorkflows -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
                + FfiConverterOptionalTypeEpisodeId.allocationSize(value.`episodeId`)
...
sealed class TranscriptWorkflowOrigin {
    ...
    object Playback : TranscriptWorkflowOrigin()
...
public object FfiConverterTypeTranscriptWorkflowOrigin : FfiConverterRustBuffer<TranscriptWorkflowOrigin>{
    override fun read(buf: ByteBuffer): TranscriptWorkflowOrigin {
        return when(buf.getInt()) {
            ...
            3 -> TranscriptWorkflowOrigin.Playback
            4 -> TranscriptWorkflowOrigin.Unsupported(
                FfiConverterUInt.read(buf),
                )
            else -> throw RuntimeException("invalid enum value, something is very wrong!!")
        }
    ...
    override fun allocationSize(value: TranscriptWorkflowOrigin): ULong = when(value) {
        ...
        is TranscriptWorkflowOrigin.Playback -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
            )
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeTranscriptWorkflowConfiguration: FfiConverterRustBuffer<TranscriptWorkflowConfiguration?> {
    override fun read(buf: ByteBuffer): TranscriptWorkflowConfiguration? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeTranscriptWorkflowConfiguration.read(buf)
    }

    override fun allocationSize(value: TranscriptWorkflowConfiguration?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeTranscriptWorkflowConfiguration.allocationSize(value)
        }
    }
    ...
    override fun write(value: TranscriptWorkflowConfiguration?, buf: ByteBuffer) {
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypeTranscriptWorkflowConfiguration.write(value, buf)
        }
    }
}
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeCompiledMemoryRecord: FfiConverterRustBuffer<CompiledMemoryRecord?> {
    override fun read(buf: ByteBuffer): CompiledMemoryRecord? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeCompiledMemoryRecord.read(buf)
    }

    override fun allocationSize(value: CompiledMemoryRecord?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeCompiledMemoryRecord.allocationSize(value)
        }
    }
    ...
    override fun write(value: CompiledMemoryRecord?, buf: ByteBuffer) {
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypeCompiledMemoryRecord.write(value, buf)
        }
    }
}
